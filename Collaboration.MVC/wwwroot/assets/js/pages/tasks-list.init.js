...
var idField = document.getElementById("tasksId"),
    taskTitleField = document.getElementById("taskTitle-field"),
    tasksDescriptionField = document.getElementById("tasksDescription-field"),
...
document.getElementById("showModal").addEventListener("show.bs.modal", function (e) {
    if (e.relatedTarget.classList.contains("edit-item-btn")) {
        document.getElementById("modalCreateUpdateTaskLabel").innerHTML = "Edit Task";
        document.getElementById("showModal").querySelector(".modal-footer").style.display = "block";
        document.getElementById("add-btn").innerHTML = "Update";
    } else if (e.relatedTarget.classList.contains("add-btn")) {
        document.getElementById("modalCreateUpdateTaskLabel").innerHTML = "Add Task";
        document.getElementById("showModal").querySelector(".modal-footer").style.display = "block";
        document.getElementById("add-btn").innerHTML = "Add Task";
    } else {
        document.getElementById("modalCreateUpdateTaskLabel").innerHTML = "List Task";
